  ...
  return (
    <div>
      <div className="pt-44 lg:px-36 px-10 bg-cover bg-center ">
        <h2 className="font-display text-4xl lg:text-6xl text-center ">Stories</h2>
      ...
      <div className="pt-16 pb-10 lg:pb-52 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 px-10 lg:px-64 mx-auto text-center gap-8">
